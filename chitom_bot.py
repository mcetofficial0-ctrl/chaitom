...
def music_command(message):
    status_msg = bot.reply_to(message, "🎧 Подключаюсь к астральному Last.fm...")
    
    music_prompt = (
        "Сгенерируй фейковый музыкальный скроббл. Придумай каждый раз АБСОЛЮТНО НОВОЕ, "
        "максимально абсурдное, ироничное или странное название трека и имя исполнителя. "
        "Опирайся на наш лор (читом, клубок, бастурма, Степан Клитор, Андрей Визард, Роман Линкин и пони), "
        "но миксуй их самым непредсказуемым образом в разных жанрах. "
        "Ответь СТРОГО в таком формате без лишнего текста и звездочек:\n"
        "🎧 Сейчас играет:\n\n"
        "🎵 [Название трека]\n"
        "👤 [Исполнитель]"
    )
