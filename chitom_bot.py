...
def music_command(message):
    ...
    music_prompt = f"""
Сгенерируй фейковый музыкальный скроббл. Придумай АБСОЛЮТНО НОВОЕ, абсурдное название трека, имя исполнителя и 3-5 жанровых хештегов. 
Опирайся на наш лор (читом, клубок, бастурма, Степан Клитор, Андрей Визард, Роман Линкин и пони), миксуй их максимально странно и иронично.
