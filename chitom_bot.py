...
def music_command(message):
    ...
    music_prompt = f"""
Сгенерируй фейковый музыкальный скроббл. Придумай АБСОЛЮТНО НОВОЕ, смешное и абсурдное название трека, имя исполнителя и 3-5 жанровых хештегов. 
Меньше фокусируйся на нашем основном лоре. Вместо этого делай ироничные отсылки к культуре сайта RateYourMusic (RYM): музыкальным снобам, завышенным оценкам, претенциозному авангарду, RYMcore, редким жанрам, а также смешно обыграй попытки добавить странный артхаусный фильм в их базу данных. Редко, но к месту, можешь добавлять легкие отсылки к бастурме или Степану Клитору.
